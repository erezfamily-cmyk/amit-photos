...
הקהל: אנשים שמתחילים להתעניין בצילום — לא מקצוענים. הם רוצים ללמוד אבל לא מכירים עדיין מונחים טכניים.
סגנון: ברור, נגיש, מעניין — כמו חבר שמסביר משהו שהוא מבין ומתלהב ממנו. לא מרצה, לא מתנשא.
...
הקהל הוא אנשים חדשים בתחום הצילום שהמידע מעניין אותם — הכל צריך להיות מובן גם בלי רקע מוקדם.
...
**גרסה 1 — פייסבוק:**
1. משפט פתיחה שמקשר בין מה שרואים בתמונה לנושא הלימודי — ברור למי שלא יודע כלום
2. אם יש EXIF — שורת הגדרות טכניות עם הסבר קצר למה כל הגדרה חשובה (אחרת דלג)
3. 2-3 שורות שמסבירות בפשטות מה ילמד מי שיכנס לדף — מה הוא יוכל לעשות אחרי שקרא
4. שורה ריקה
5. 👉 ללמוד עוד: {page['url']}

**גרסה 2 — אינסטגרם:**
1. משפט hook קצר ומושך שמסקרן — לא מניח ידע מוקדם
2. אם יש EXIF — שורה טכנית קצרה עם הסבר פשוט (אחרת דלג)
3. 1-2 שורות קצרות — מה לומדים ולמה זה שימושי
4. שורה ריקה
5. 👉 קישור בביו ← {page['title']} {page['emoji']}

**גרסה 3 — Threads:**
1. משפט אחד פשוט ומסקרן — עובדה מעניינת או שאלה שגורמת לאנשים לחשוב
2. שאלה קצרה אחת לקהל שמזמינה תגובה
3. שורה ריקה
4. {page['url']}
(קצר מאוד — מקסימום 150 תווים עד לפני הקישור)

**גרסה 4 — Pinterest (באנגלית):**
2-3 משפטים ברורים שמסבירים מה לומדים בדף ולמה זה שימושי למתחיל. ללא ז'רגון.
