...
const TRANSLATIONS = {
  he: {
    ...
    'payments.disabled.title': 'הרכישה המקוונת נמצאת בשדרוג אבטחה',
    'payments.disabled.hero':  'הגלריה פתוחה לעיון. לרכישה ניתן ליצור קשר ישירות עם עמית.',
    'payments.disabled.text':  'בינתיים ניתן לבחור תמונה בגלריה ולתאם רכישה ישירות עם עמית. התשלום יתבצע ידנית באמצעות Bit או PayBox.',
    ...
    'pricing.contact':  'יצירת קשר לרכישה',
    ...
    'gallery.item.aria':'פתח תצוגה מוגדלת',
  ...
  en: {
    ...
    'payments.disabled.title': 'Online purchasing is undergoing a security upgrade',
    'payments.disabled.hero':  'The gallery is open for browsing. To purchase, please contact Amit directly.',
    'payments.disabled.text':  'For now, choose a photo in the gallery and arrange the purchase directly with Amit. Payment is handled manually via Bit or PayBox.',
    ...
    'pricing.contact':  'Contact to Purchase',
    ...
    'faq.a2':           'Usually 5–10 business days from confirmation. Prints are produced locally by Gelato — in the US, EU, UK and more — and shipped directly to your address.',
    'faq.q3':           'What\'s included in the price?',
    'faq.a3':           'The displayed price includes printing + packaging + shipping to your door. Gelato produces prints locally in 32+ countries, so no import fees for most destinations.',
    ...
    'gallery.item.aria':'Open enlarged view',
    ...
    'buy.price.original': 'Regular price',
    'buy.total':          'Total',
    ...
    'print.customs':    '✓ Printed locally via Gelato — no import fees for US, EU & UK orders.',
    ...
    'print.price':      '${{price}} — printed locally · shipping included',
    'print.price.err':  'Error loading price',

    // print types (catalog override)
    'print.type.poster.label':   'Poster — Matte Art Paper',
    'print.type.poster.desc':    '170gsm art paper, matte finish — printed locally near you, shipping included',
    'print.type.canvas.label':   'Canvas Print',
    'print.type.canvas.desc':    'Canvas stretched on a wooden frame, ready to hang — printed locally, shipping included',
    'print.type.metallic.label': 'Metal Print',
    'print.type.metallic.desc':  '3mm aluminum print — glossy luxury finish, ready to hang — printed locally, shipping included',
    ...
    'pc.ok.p1':         'Your print has been sent to a Gelato production facility near you and will arrive within 5–10 business days.',
