...
const TRANSLATIONS = {
  he: {
    ...
    'journey.label':       'בחרו איך להתחיל',
    'journey.title':       'צילום לצפייה, ללמידה וליציאה לשטח',
    'gallery.home.label':  'הגלריה',
    'gallery.home.title':  'תמונות נבחרות',
    'gallery.home.subtitle': 'בחרו קטגוריה או פתחו תמונה כדי לראות אותה מקרוב.',
    ...
    'explore.gallery.title':      'לצפות בגלריה',
    'explore.gallery.desc':       'מבחר תמונות טבע, נוף, מאקרו ומסעות — מסודר לפי נושאים ומקומות.',
    'explore.gallery.cta':        'לתמונות ←',
  ...
  en: {
    ...
    'journey.label':       'Choose your path',
    'journey.title':       'Photography to explore, learn, and take into the field',
    'gallery.home.label':  'The Gallery',
    'gallery.home.title':  'Selected Photographs',
    'gallery.home.subtitle': 'Choose a category or open a photograph for a closer look.',
    ...
    'explore.gallery.title':      'Explore the Gallery',
    'explore.gallery.desc':       'Nature, landscape, macro, and travel photography — organized by subject and location.',
    'explore.gallery.cta':        'View Photos →',
