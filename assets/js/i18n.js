...
const TRANSLATIONS = {
  he: {
    ...
    'htb.s2.title':     'לחץ על תמונה',
    'htb.s2.desc':      'לחץ "רכישה" ובחר את הרזולוציה המתאימה לשימוש שלך.',
  ...
  en: {
    ...
    'htb.s2.title':     'Click a Photo',
    'htb.s2.desc':      'Click "Purchase" and choose the resolution that fits your use.',
